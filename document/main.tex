...
\begin{document}
    \begin{titlepage}
        ...
        {\fontsize{20pt}{20pt}\selectfont \textbf{Proyecto}\\[0.5 cm] Análisis y Procesamiento Digital de Señales\\[0.2cm] del Magnetómetro 	MAG en la Misión Venus Express }\\[3cm]
